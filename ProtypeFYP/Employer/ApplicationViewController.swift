...
class ApplicationViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.saveButton.layer.cornerRadius = 22
        cell.cvProfile.layer.masksToBounds = false
        cell.cvProfile.layer.borderColor = UIColor.white.cgColor
        cell.cvProfile.layer.cornerRadius = 40
        cell.cvProfile.clipsToBounds = true
