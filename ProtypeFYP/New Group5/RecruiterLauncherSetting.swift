...
class RecruiterSettings: NSObject {
    let name: String
...
class RecruiterLauncherSettings: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
