...
class RecruiterController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    let titles = ["Home" ,"Jobs" , "Subscribed Jobs", "Account"]
    ...
    func setupNavBarButtons(){
        ...
        let moreBarButton = UIBarButtonItem(image: UIImage(named: "dots")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleMoreButton))
    ...
    private func setupMenuBar (){
        ...
        redView.backgroundColor = UIColor.darkGray
